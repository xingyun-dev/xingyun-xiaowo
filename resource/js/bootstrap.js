...
(function (global, factory) {
  ...
  class Config {
    ...
    static get NAME() {
      throw new Error('You have to implement the index-static method "NAME", for each component!');
    }
    _getConfig(config) {
  ...
  class Dropdown extends BaseComponent {
    ...
    _getPopperConfig() {
      ...
      // Disable Popper if we have a index-static display or Dropdown is in Navbar
  ...
  const CLASS_NAME_STATIC = 'modal-index-static';
  ...
  class Modal extends BaseComponent {
    ...
    _initializeBackDrop() {
      return new Backdrop({
        ...
        // 'index-static' option will be translated to true, and booleans will keep their value,
